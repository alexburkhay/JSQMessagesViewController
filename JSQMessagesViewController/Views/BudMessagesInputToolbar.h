...
@class BudMessagesInputToolbar;

@protocol BudMessagesInputToolbarDelegate <UIToolbarDelegate>
 ...
 */
- (void)messagesInputToolbar:(BudMessagesInputToolbar *)toolbar
 ...
 */
@interface BudMessagesInputToolbar : UIToolbar

/**
 *  The object that acts as the delegate of the toolbar.
 */
@property (weak, nonatomic) id<BudMessagesInputToolbarDelegate> delegate;

/**
 *  Returns the content view of the toolbar. This view contains all subviews of the toolbar.
 */
@property (weak, nonatomic, readonly) BudMessagesToolbarContentView *contentView;
